...
// Replace modshells, Modshells — See README.adoc for details., just run, Modshells started successfully. with actuals
= modshells — Quick Start for Users
:toc:
:toclevels: 2

== What is modshells?

Modshells — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./modshells-portable
----
...
[source]
----
Modshells started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/modshells/wiki
