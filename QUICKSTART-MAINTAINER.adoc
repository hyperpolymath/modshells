...
// Replace modshells, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= modshells — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining modshells for
...
* Upstream: https://github.com/hyperpolymath/modshells/issues
